    ...
    >
      <div className="sf-dropdown-menu sf-table-alignment-menu">
        <div className="sf-dropdown-menu-item" onMouseDown={() => setTextAlignStyle('left')}>
          <div className='sf-checked'><i className={classNames('iconfont icon-check-mark', { active: !horizontalAlign || horizontalAlign === 'left' })}></i></div>
          <span className='active'>{t('Left')}</span>
        </div>
        <div className="sf-dropdown-menu-item" onMouseDown={() => setTextAlignStyle('center')}>
          <div className='sf-checked'><i className={classNames('iconfont icon-check-mark', { active: horizontalAlign === 'center' })}></i></div>
          <span>{t('Center')}</span>
        </div>
        <div className="sf-dropdown-menu-item" onMouseDown={() => setTextAlignStyle('right')}>
          <div className='sf-checked'><i className={classNames('iconfont icon-check-mark', { active: horizontalAlign === 'right' })}></i></div>
          <span>{t('Right')}</span>
        </div>
      </div>
    </UncontrolledPopover >
